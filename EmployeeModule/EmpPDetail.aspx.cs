...
{
	/// <summary>
	/// Summary description for EmpPDetail.
	/// </summary>
	public partial class EmpPDetail : System.Web.UI.Page
	{
		...
		protected void Button1_Click(object sender, System.EventArgs e)
		{
			...
			SqlDataAdapter apt=new SqlDataAdapter("select * from crm_empreg where empid='"+TextBox1.Text+"'",con);
